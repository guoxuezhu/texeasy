...
public class RecognizeConfiguration {
    ...
    public static class Builder {
        ...
        private float imageQualityNoMaskRecognizeThreshold = 0.49f;//todo ConfigUtil.IMAGE_QUALITY_NO_MASK_RECOGNIZE_THRESHOLD;
        private float imageQualityMaskRecognizeThreshold = 0.29f; //todo ConfigUtil.IMAGE_QUALITY_MASK_RECOGNIZE_THRESHOLD;
