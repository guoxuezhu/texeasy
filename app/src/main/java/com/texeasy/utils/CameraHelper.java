...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    private Camera.Size getBestSupportedSize(List<Camera.Size> sizes, Point previewViewSize) {
        ...
        Logcat.d(KLog.TAG, "getBestSupportedSize previewViewSize: " + previewViewSize.toString());
        ...
        Logcat.d(KLog.TAG, "getBestSupportedSize bestSize: " + bestSize.width + "x" + bestSize.height);
        return bestSize;
    }
