package com.texeasy.utils.faceserver;
...
import com.texeasy.utils.CompareResult;
import com.texeasy.utils.FaceEntity;
    ...
    public synchronized void init(Context context, OnInitFinishedCallback onInitFinishedCallback) {
        if (faceEngine == null && context != null) {
            ...
            if (engineCode == ErrorInfo.MOK) {
                ...
                faceEngine = null;
                Logcat.e(KLog.TAG, "init: failed! code = " + engineCode);
            }
        }
...
//        }
    ...
    private void registerFaceFeatureInfoListFromDb(FaceEngine faceEngine, List<FaceEntity> faceEntityList) {
        ...
        if (faceEngine != null) {
            ...
            Logcat.d(KLog.TAG, "registerFaceFeature:" + res);
        }
    }
    ...
    private String getImageDir() {
        return BaseApplication.getInstance().getExternalFilesDir(Environment.DIRECTORY_PICTURES)
